            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-zinc-900 border border-white/10 rounded-3xl p-8 shadow-2xl">
                    <div className="text-center mb-8">
                        <h2 className="text-2xl font-bold text-white mb-2">SocialSync Internal</h2>
                    ...
                    <div className="mt-8 flex items-center gap-2 justify-center py-3 border-t border-white/5">
                        ...
                        <span className="text-[10px] text-zinc-600 font-bold uppercase tracking-widest">Secured by SocialSync Engine</span>
                    </div>
                </div>
