          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              <div>
                ...
                <a href={`tel:${(process.env.NEXT_PUBLIC_SUPPORT_PHONE || "0413592054").replace(/\s/g, "")}`} className="text-slate-900 hover:text-yellow-600 transition-colors font-bold text-lg">
