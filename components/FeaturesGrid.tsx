            ...
            <div className="max-w-6xl mx-auto px-5">
                ...
                <div className={`grid ${gridCols[columns]} gap-6`}>
                    {features.map((feature, index) => (
                        <div key={index} className="flex items-center gap-4 bg-white p-4 rounded-lg border border-slate-200 shadow-sm">
                            ...
                            <div>
                                ...
                                {feature.sublabel && <div className="text-xs text-slate-500">{feature.sublabel}</div>}
                            </div>
                        </div>
                    ))}
                </div>
