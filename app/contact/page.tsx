            ...
            <div className="space-y-8">
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-8 shadow-sm">
                ...
                <div className="space-y-6">
                  <a href={`tel:${(process.env.NEXT_PUBLIC_SUPPORT_PHONE || "0413 592 054").replace(/\s/g, "")}`} className="flex items-center gap-4 group hover:bg-slate-50 p-2 rounded transition-colors -mx-2">
                    <div className="w-12 h-12 bg-yellow-400 rounded-lg flex items-center justify-center text-slate-900 shadow-sm">
                    ...
                    <div>
                      ...
                      <div className="text-2xl font-black text-slate-900 group-hover:text-yellow-600 transition-colors">{process.env.NEXT_PUBLIC_SUPPORT_PHONE}</div>
                    </div>
                  </a>

                  <a href="mailto:liam@turnerinstalls.com" className="flex items-center gap-4 group hover:bg-slate-50 p-2 rounded transition-colors -mx-2">
                    <div className="w-12 h-12 bg-slate-900 rounded-lg flex items-center justify-center text-white border border-slate-200 shadow-sm">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-6 h-6">
                    ...
                    <div>
                      ...
                      <div className="text-lg font-bold text-slate-900 group-hover:text-yellow-600 transition-colors">liam@turnerinstalls.com</div>
                    </div>
                  </a>
                </div>
              </div>
              ...
              {/* Service Area */}
              <div className="p-8 rounded-xl border border-slate-200 bg-slate-50 shadow-inner">
                <h3 className="text-lg font-black mb-4 flex items-center gap-2 text-slate-900 uppercase">
                ...
                <div className="flex flex-wrap gap-2">
                  {["Brisbane City", "Northside", "Southside", "Ipswich", "Logan", "Redlands"].map(area => (
                    <div key={area} className="bg-white border border-slate-200 px-3 py-1.5 rounded text-xs font-bold text-slate-700 shadow-sm">
                      {area}
                    </div>
                  ))}
                </div>
