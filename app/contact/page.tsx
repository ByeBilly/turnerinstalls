            ...
            <div className="space-y-8 lg:pt-10">
              ...
              <div className="bg-gradient-to-br from-gray-900 to-black border border-gray-800 rounded-3xl p-8">
                ...
                <div className="space-y-6">
                  ...
                  <a href="mailto:liam@turnerinstalls.com" className="flex items-center gap-4 group">
                    ...
                    <div>
                      ...
                      <div className="text-lg font-medium text-white group-hover:text-yellow-400 transition-colors">liam@turnerinstalls.com</div>
                    </div>
                  </a>
                </div>
              </div>
