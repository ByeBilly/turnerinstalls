            ...
            <div className="space-y-8">
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-8 shadow-sm">
                ...
                <div className="space-y-6">
                  <a href={`tel:${process.env.NEXT_PUBLIC_SUPPORT_PHONE?.replace(/\s/g, "")}`} className="flex items-center gap-4 group hover:bg-slate-50 p-2 rounded transition-colors -mx-2">
